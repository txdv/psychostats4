...
extends Psychostats_Method_Get_Map_Stats {
	protected function get_sql() {
		...
		$sql['assisted_kills_pct'] = 'IFNULL(d.custom_kills / d.kills * 100, 0) assisted_kills_pct';
		$sql['backstab_kills_pct'] = 'IFNULL(d.backstab_kills / d.kills * 100, 0) backstab_kills_pct';
